...
<rss version="2.0" xmlns:content="http://purl.org/rss/1.0/modules/content/">
  <channel>
    ...
    <description>Essays on context infrastructure and AI agents</description>
...
export function generateLlmsTxt(baseUrl) {
  const posts = getAllPosts();
  const lines = [
    '# MOI Blog — Context Infrastructure & AI Agents',
    '',
    '> Essays on building trustworthy AI systems through shared context.',
    '',
