...
export default function HowItWorksPage() {
  ...
  useEffect(() => {
    ...
    function draw() {
      ...
      const boxes = [
        { x: cx - 80, y: cy, name: "Alice", color: "#4B17E5", fields: ["identity", "assets: 500 MOI", "trust: 0.94", "auth: scoped"] },
  ...
  return (
    <>
      <style>{`
        ...
        .how-canvas-sticky { position: sticky; top: 72px; width: 100%; height: calc(100vh - 72px); background: #FCFBFF; }
        ...
        .canvas-label { font-size: 10px; letter-spacing: 0.15em; color: #4B17E5; text-transform: uppercase; margin-bottom: 10px; }
        .canvas-title { font-family: 'Instrument Serif', serif; font-size: clamp(24px, 3.5vw, 44px); line-height: 1.15; max-width: 520px;
          text-shadow: 0 0 30px #FCFBFF, 0 0 60px #FCFBFF, 0 0 90px #FCFBFF; }
        ...
        .canvas-cta-primary { display: inline-flex; align-items: center; padding: 13px 32px;
          background: #0A051A; color: #FCFBFF; border-radius: 100px;
        ...
        .canvas-cta-primary:hover { background: #4B17E5; transform: translateY(-1px); }
        .canvas-cta-secondary { display: inline-flex; align-items: center; padding: 13px 32px;
          background: transparent; color: #0A051A; border: 1px solid rgba(26,26,26,0.2); border-radius: 100px;
          font-family: 'DM Mono', monospace; font-size: 11px; letter-spacing: 0.12em; text-transform: uppercase;
          text-decoration: none; transition: all 0.3s; }
        .canvas-cta-secondary:hover { border-color: #4B17E5; color: #4B17E5; }
        .how-panel { min-height: 100vh; display: flex; align-items: center; padding: 120px 60px; position: relative; background: #FCFBFF; }
        ...
        .panel-label { font-size: 10px; letter-spacing: 0.15em; color: #4B17E5; text-transform: uppercase; margin-bottom: 16px; }
        ...
        .panel-body strong { color: #0A051A; font-weight: 400; }
        .vis-box { background: #FCFBFF; border: 1px solid rgba(26,26,26,0.06); border-radius: 16px; padding: 32px; min-height: 340px; display: flex; align-items: center; justify-content: center; overflow: hidden; }
        .how-comparison { display: grid; grid-template-columns: 1fr 1fr; gap: 2px; background: rgba(26,26,26,0.06); }
        .comp-side { background: #FCFBFF; padding: 60px 40px; display: flex; flex-direction: column; align-items: center; justify-content: center; text-align: center; }
        .comp-label { font-size: 10px; letter-spacing: 0.15em; text-transform: uppercase; margin-bottom: 12px; }
        .comp-label.old { color: #C0392B; }
        .comp-label.new { color: #4B17E5; }
        ...
        .comp-stat.new { color: #4B17E5; }
        .comp-desc { font-size: 12px; color: rgba(26,26,26,0.35); line-height: 1.6; max-width: 280px; }
        .how-cta { min-height: 50vh; display: flex; flex-direction: column; align-items: center; justify-content: center; text-align: center; padding: 80px 40px; background: #FCFBFF; }
        ...
        .cta-btn { border: 1px solid rgba(26,26,26,0.2); border-radius: 100px; padding: 14px 36px; font-family: 'DM Mono', monospace; font-size: 11px; letter-spacing: 0.15em; color: #0A051A; background: transparent; cursor: pointer; transition: all 0.4s; text-decoration: none; }
        .cta-btn:hover { background: #0A051A; color: #FCFBFF; }
      ...
      <nav
        ...
        style={{ background: "#FCFBFF", borderBottom: "1px solid rgba(26,26,26,0.12)" }}
      >
        <Link to="/" className="flex items-center gap-3">
          <img src="/logo-moi-mark.png" alt="MOI logo" className="h-12 w-12 shrink-0" />
          <span className="font-mono text-xs tracking-[0.35em] uppercase font-medium text-[#0A051A]">MOI</span>
        </Link>
        <div className="flex items-center gap-12">
          <a
            ...
            className="font-mono text-[11px] tracking-[0.18em] uppercase text-[#0A051A]/50 hover:text-[#0A051A] transition-colors duration-300"
            style={{ fontWeight: 500 }}
          >
            Docs
          </a>
          <span
            className="font-mono text-[11px] tracking-[0.18em] uppercase text-[#0A051A] transition-colors duration-300"
            style={{ fontWeight: 500 }}
          >
            The Shift
          </span>
      ...
      <div ref={sectionRef} className="how-canvas-section" style={{ background: "#FCFBFF" }}>
